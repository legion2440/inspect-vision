...
def test_mild_defect_uses_quality_v1_formula() -> None:
    ...
    score = calculate_quality_score((mild,), image_width=100, image_height=100)
...
def test_multiple_defects_compound_penalty() -> None:
    ...
    combined = calculate_quality_score((first, second), image_width=100, image_height=100)
    individual = calculate_quality_score((first,), image_width=100, image_height=100)
...
def test_severe_defects_clamp_score_to_zero() -> None:
    ...
    assert calculate_quality_score(severe, image_width=100, image_height=100) == 0
